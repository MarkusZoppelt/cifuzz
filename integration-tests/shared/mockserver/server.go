...
//go:embed testdata/container_remote_run_status.json
var ContainerRemoteRunStatusResponse string
...
//go:embed testdata/container_registry_credentials.json
var ContainerRegstryCredentialsResponse string
